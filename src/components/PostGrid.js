        ...
        <div className={"my-3 md:my-9 pb-5 border-b border-gray-200"}>
            ...
            <div className={"flex "}>
                ...
                <div className="w-fit md:w-1/5 flex justify-center aspect-square">
                    { (post.field_image.uri.url)? <Image className={"object-contain h-auto w-auto"} src={ process.env.BACKEND_URL + post.field_image.uri.url} alt={"none"} width={220} height={220}/> : ""}
