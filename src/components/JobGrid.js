        ...
        <div className={"my-3 md:my-9 min-w-full border-b border-gray-200"}>
            <div className={"flex md:mx-auto"}>
                ...
                <div className="flex items-center my-3 justify-center">
                    <Link href={ post.path.alias?? '/node/'+post.drupal_internal__nid } className={"dark:bg-gray-300 bg-gray-800 my-2 p-4 rounded mr-3"}>View</Link>
                    <Link target={"_blank"} href={post.field_url.uri} className={"dark:bg-gray-300 bg-gray-800 my-2 p-4 rounded"}>Source</Link>
                </div>
